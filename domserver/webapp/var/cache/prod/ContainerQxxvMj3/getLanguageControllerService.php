...
$instance->setContainer(($this->privates['.service_locator.heoBWpA'] ?? $this->load('get_ServiceLocator_HeoBWpAService.php'))->withContext('App\\Controller\\API\\LanguageController', $this));
