...
";
    ...
    <div class=\"row\">
      <div class=\"col-12\">
        ...
        ";
        // line 21
        echo twig_call_macro($macros["macros"], "macro_table", [(isset($context["judgehost_restrictions"]) || array_key_exists("judgehost_restrictions", $context) ? $context["judgehost_restrictions"] : (function () { throw new RuntimeError('Variable "judgehost_restrictions" does not exist.', 21, $this->source); })()), (isset($context["table_fields"]) || array_key_exists("table_fields", $context) ? $context["table_fields"] : (function () { throw new RuntimeError('Variable "table_fields" does not exist.', 21, $this->source); })()), (isset($context["num_actions"]) || array_key_exists("num_actions", $context) ? $context["num_actions"] : (function () { throw new RuntimeError('Variable "num_actions" does not exist.', 21, $this->source); })())], 21, $context, $this->getSourceContext());
        // line 23
      ...
      <div class=\"col-12\">
        ...
        {%- if is_granted('ROLE_ADMIN') %}
          <p>
            {{
              button(
                path('jury_judgehost_restriction_add'),
                'Add new judgehost restriction',
                'primary',
                'plus'
              )
            }}
